...
+ 'FN:Luminus\n' // Nama
+ 'ORG:Luminus-Bot;\n' // Nama bot
+ 'TEL;type=CELL;type=VOICE;waid=520123456789:+52 012 345 6789\n' // Nomor bot
+ 'END:VCARD' 
...
Usa ${prefix}verify para verificarte y poder usar el bot.`
  ...
  only: {
    ...
    ownerB: 'Este comando solo puede ser usado por mi amo Luminus',
...
┃ _Ex : ${prefix}Ephoto 25 Luminus_
┠⊷️ *${prefix}Textpro list*
┃ _Lista de textpro
┠⊷️ *${prefix}Textpro (code + Texto)*
┃ _Ex : ${prefix}Textpro 55 Luminus_
┗━━━━━━━━━━━━━━━━━━━━
*〘 IMAGENES 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Cogan*
...
_Este bot es gratis :) , si quieres que entre a tu grupo habla con mi dueño_
...
pok = await getBuffer(nimek)
Lxa.sendMessage(from, pok, image, {
  quoted: mek, caption: `Luminus-Bot`
})
...
//--Convert stiker to image
				case 'toimg':
					...
					exec(`ffmpeg -i ${medimg} ${ran}`, (err) => {
						...
						buffer = fs.readFileSync(ran)
						Lxa.sendMessage(from, buffer, image, {quoted: mek, caption: 'Luminus-Bot'})
						fs.unlinkSync(ran)
					})
					break
